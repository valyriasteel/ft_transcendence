...
from .views import LoginIntra42View, CallbackIntra42View, Verify2FAView, LogoutAPIView, GamePageView, TestApiView, IndexRender
...
urlpatterns = [
    ...
    path('get_profil/', GamePageView.as_view(), name='get_profil'),
